...
import 'package:dorm_sync/ui/excel/deactivate_stu_excel.dart';
...
class DeactivatedListScreen extends StatefulWidget {
  const DeactivatedListScreen({super.key});

  @override
  State<DeactivatedListScreen> createState() => _DeactivatedListScreenState();
}

class _DeactivatedListScreenState extends State<DeactivatedListScreen> {
  List<DeactivatedList> deactiveteList = [];
  ...
  List<DeactivatedList> get _filteredData {
    List<DeactivatedList> result =
        deactiveteList; // Initialize with unfiltered data
    if (_searchQuery.isNotEmpty) {
      final query = _searchQuery.toLowerCase();

      result =
          deactiveteList.where((item) {
  ...
  List<DeactivatedList> get _pagedData {
                  ...
                  InkWell(
                    onTap: () async {
                      var updatedData = await Navigator.of(
                        context,
                      ).pushNamed('/deactive Student', arguments: null);
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: IconButton(
                        onPressed: () async {
                          await exportDeactivatedListToExcel(_filteredData);
                        },
                ...
                ..._pagedData.map((item) {
                  return TableRow(
                    ...
                    children: [
                      ...
                      tableBody(item.leaveDate ?? ""),
                      tableBody(item.reason ?? ""),
                      TableCell(
                        child: Padding(
