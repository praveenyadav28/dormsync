...
class _BranchListScreenState extends State<BranchListScreen> {
  ...
  List<BranchList> get _filteredData {
    List<BranchList> result = branchList; // Initialize with unfiltered data
    if (_searchQuery.isNotEmpty) {
      final query = _searchQuery.toLowerCase();

      result =
          branchList.where((item) {
  ...
  List<BranchList> get _pagedData {
