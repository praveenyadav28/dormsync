...
class _BankReportState extends State<BankReport> {
  ...
  Future geLedgerData() async {
    final response = await ApiService.fetchData(
      'ledger_id_name?ledger_id=$ledgerId&ledger_name=${ledgerNameController.text.toString()}&licence_no=${Preference.getString(PrefKeys.licenseNo)}&branch_id=${Preference.getint(PrefKeys.locationId)}',
    );
